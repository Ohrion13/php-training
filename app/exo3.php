        ...
        <section class="exercice">
            ...
            <div class="exercice-sandbox">
                ...
                foreach ($store as $fruits => $prices) {
                    ...
                    if (!isset($lowestPrice) || $lowestPrice > $prices) {
                        $lowestPrice = $prices;
                        $fruit = $fruits;
                ...
                echo "<p>le fruit le moins cher est {$fruit} et il coûte {$lowestPrice}.</p>";
        ...
        <section class="exercice">
            ...
            <div class="exercice-sandbox">
                ...
                foreach ($store as $fruits => $prices) {
                    ...
                    if (!isset($mostPrice) || $mostPrice < $prices) {
                        $mostPrice = $prices;
                        $fruit = $fruits;
                ...
                echo "<p>le fruit le plus cher est {$fruit} et il coûte {$mostPrice}.</p>";
